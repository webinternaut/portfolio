  ...
  return (
    <div className="max-w-sm m-3  ">
      <Link href={`/projects/${project.id}`} >
          <img src={project.imageUrl} alt={project.title} className="rounded-lg hover:shadow-3xl transition ease-in-out delay-50 bg-blue-500 hover:-translate-y-2 hover:scale-200 duration-600" />
          <h3>{project.title}</h3>
